...
public class TrailersFragment extends Fragment{
    public WebView webTrailersView;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.trailers_fragment, container, false);
        ...
        webTrailersView.getSettings().setUserAgentString(ua);
        // Force links and redirects to open in the WebView instead of in a browser
        webTrailersView.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);
        // Force links and redirects to open in the WebView instead of in a browser
        mWebChromeClient = new MyWebChromeClient();
        webTrailersView.setWebChromeClient(mWebChromeClient);
        webTrailersView.setWebViewClient(new WebViewClient() {
...
// This is important as it forces webview to load from the instead of reloading from cache
        ...
        webTrailersView.setOnKeyListener((v, keyCode, event) -> {
            if (keyCode == KeyEvent.KEYCODE_BACK
                ...
                if(webTrailersView.canGoBack()&& mCustomView == null) {
                    handler.sendEmptyMessage(1);
                    webTrailersView.goBack();
                    return true;
                }
                else
                {
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        webTrailersView.saveState(outState);
    }

    @Override
    public void onViewStateRestored(@Nullable Bundle savedInstanceState) {
        super.onViewStateRestored(savedInstanceState);
        webTrailersView.restoreState(savedInstanceState);
    }
